...
<div class="container">
    ...
    <div class="chart-card">
        <div class="chart-duration" id="durationBar">
            <button class="active" onclick="setDuration(60)">5m</button>
            <button onclick="setDuration(360)">30m</button>
            <button onclick="setDuration(720)">1h</button>
